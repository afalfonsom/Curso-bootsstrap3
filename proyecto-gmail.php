...
<body>
	...
	<!--Primer Contenedor logo google y botón crear cuenta -->
	<div class="container-fluid well">
		
		<div class="row">

			<!--Columna logo con imagen resposive-->
			...
			<!--columna link y boton crear cuenta solo es visible en xs-->
							...
							<div class="col-xs-12 col-sm-3">
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-3">
										...
										<script type="js/jquery-1.11.1.min"></script>
